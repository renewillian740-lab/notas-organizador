...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    <div className="p-8 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-slate-900 to-slate-800 p-6 rounded-3xl text-white shadow-xl shadow-slate-900/10 border border-slate-700/60">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl font-black tracking-tight">Organizador Automático de NF-e & NFS-e</h1>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-slate-700/80 hover:bg-slate-700 text-slate-200 text-xs font-bold border border-slate-600 transition-all flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold shadow-lg shadow-blue-600/30 transition-all flex items-center gap-2"
          >
                  ...
                  recentHistory.slice(0, 6).map((item) => (
                    <tr key={item.id} className="hover:bg-slate-50/70 transition-colors">
                      ...
                      <td className="py-3.5 px-6">
                        ...
                        <span className="text-[11px] text-slate-400 font-mono block">{item.cnpj}</span>
                      </td>
